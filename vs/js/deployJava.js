    ...
    installLatestJRE: function() {
        if (deployJava.isPluginInstalled()) {
            ...
            if ((deployJava.EAInstallEnabled == 'true') && (platform.indexOf('win') != -1) && (deployJava.EarlyAccessURL != null)) {
                ...
                //location.href
                this.installPage = deployJava.EarlyAccessURL;
                ...
                if (browser == 'MSIE') {
                    ...
                    //location.href
                    this.installPage = deployJava.getJavaURL + ((deployJava.returnPage != null) ? ('&returnPage=' + deployJava.returnPage) : '') + ((deployJava.locale != null) ? ('&locale=' + deployJava.locale) : '') + ((deployJava.brand != null) ? ('&brand=' + deployJava.brand) : '');
                }
...
//        }
    ...
    IEInstall: function() {
        //location.href
       this.installPage = deployJava.getJavaURL + ((deployJava.returnPage != null) ? ('&returnPage=' + deployJava.returnPage) : '') + ((deployJava.locale != null) ? ('&locale=' + deployJava.locale) : '') + ((deployJava.brand != null) ? ('&brand=' + deployJava.brand) : '') + ((deployJava.installType != null) ? ('&type=' + deployJava.installType) : '');
