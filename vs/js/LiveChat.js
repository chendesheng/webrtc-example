var comm100_server = "localhost:9527";
...
function comm100_livechat(server, console) {
    ...
    var jsObj = comm100.getCurrentScriptObj("comm100.com/js/livechat.js");
    if (jsObj == null)
        return;
    server = "https://" + server;
    var useHttpInCustomImage = (jsObj.src.indexOf("http:") == 0);
        ...
        var site = {
            ...
            onPageVisited: function (visitorId, sessionId, heartbeatDurConfig, stopHeartbeatDur, autoInvites) {
                ...
                if (heartbeatDurConfig.length > 0)
                    site.ifShowMarketingPage = (heartbeatDurConfig[0].d == 60);
            ...
            openChatWindow: function (e, planId, parterId, source, sourceId) {
                ...
                if (site.ifShowMarketingPage)
                    params += "&comm100marketingaooooooa=1";
            ...
            replaceImageSrc: function (src) {
                //change to http if livechat.js is accessed though http, only do this in custom url image
                if (useHttpInCustomImage && imgSrc.toLower().indexOf('comm100.com/dbresource/dbimage.ashx') == -1) {
            ...
            updateChatButtonWithoutCheckChange: function (b, isOnline) {
                ...
                if (b.type == comm100.buttonType.image) {
                    ...
                    if (img.style.display != 'none') {
                        ...
                        imgSrc = site.replaceImageSrc(imgSrc);
                        if (imgSrc != img.src) {
...
(function() {
    ...
    if (checkIfEnableConsole()) {
        if (typeof window.comm100_console_loaded != 'function') {
            window.document.write("<script type='text/javascript' src='https://" + window.comm100_server + "/js/console.js'></script>");
