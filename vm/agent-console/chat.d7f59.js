...
function createChatListState(state) {
  ...
  var preferenceOther = __WEBPACK_IMPORTED_MODULE_5__reducers_selectors__["_105" /* getPreferenceOthers */](state);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__constants_enums_audioVideoChatStatus__ = __webpack_require__(289);
...
var getChatActionDisplay = __WEBPACK_IMPORTED_MODULE_4_lru_memoize___default()(1)(function (siteInfo, ifHaveTransferPermission, ifEnableTranslate, ifG2MConnected, campaign) {
  return {
    ...
    videoChat: __WEBPACK_IMPORTED_MODULE_6_src_utils_common__["p" /* ifSupportWebrtc */] };
});
...
var mergeProps = function mergeProps(stateProps, dispatchProps) {
  ...
  var dispatchObject = {
    ...
    onRequestAudioChat: function onRequestAudioChat() {
      ...
      p2pChat.requirePermission().then(function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__constants_enums_audioVideoChatStatus__ = __webpack_require__(289);
...
var mapStateToProps = function mapStateToProps(state, _ref) {
  ...
  var errorMessageForChat = __WEBPACK_IMPORTED_MODULE_3__reducers_selectors__["_101" /* getErrorMessageForChat */](state, chat && chat.get('id'));
  ...
  var avStatus = audioVideoChatAgentName === '' || audioVideoChatAgentName === __WEBPACK_IMPORTED_MODULE_3__reducers_selectors__["N" /* getCurrentAgent */](state).name ? chat.get('audioVideoStatus') : __WEBPACK_IMPORTED_MODULE_8__constants_enums_audioVideoChatStatus__["a" /* notStart */];
  ...
  var ret = {
    ...
    messages: __WEBPACK_IMPORTED_MODULE_3__reducers_selectors__["_102" /* getChatMessages */](state, __WEBPACK_IMPORTED_MODULE_3__reducers_selectors__["_40" /* getSelectedChatId */](state)),
...
//# sourceMappingURL=chat.d7f59.js.map